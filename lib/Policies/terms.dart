...
<p>
  These terms and conditions outline the rules and regulations for the use of init app.
</p>

<p>
  By accessing this app we assume you accept these terms and conditions. Do
  not continue to use init if you do not agree to take all of the
...
<p>
  We employ the use of cookies. By accessing init, you agreed to use
  cookies in agreement with the init Privacy Policy.
</p>

<p>
  Most interactive apps use cookies to let us retrieve the user’s details
...
<p>
  Unless otherwise stated, init and/or its licensors own the intellectual
  property rights for all material on init. All intellectual property
  rights are reserved. You may access this from init for your own
  personal use subjected to restrictions set in these terms and conditions.
</p>

<p>You must not:</p>
<ul>
  <li>Republish material from init</li>
  <li>Sell, rent or sub-license material from init</li>
  <li>Reproduce, duplicate or copy material from init</li>
  <li>Redistribute content from init</li>
</ul>
...
<p>
  ...
  opinions and information in certain areas of the website. init does not
  filter, edit, publish or review Comments prior to their presence on the
  website. Comments do not reflect the views and opinions of init,its
  ...
  applicable laws, init shall not be liable for the Comments or for any
...
<p>
  init reserves the right to monitor all Comments and to remove any
...
<p>
  You hereby grant init a non-exclusive license to use, reproduce, edit and
...
<p>
  ...
  absence of init; and (d) the link is in the context of general resource
  information.
</p>
...
<p>
  ...
  to init. Please include your name, your organization name, contact
...
<p>
  No use of init's logo or other artwork will be allowed for linking absent
