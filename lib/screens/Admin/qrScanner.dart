          ...
          onDetect: (barcode, args) async {
            if (barcode.rawValue == null) {
              ...
              if (!key.docs.first.id.isEmpty) {
                if ((keyd.data() as dynamic)["College"] ==
                    BlocProvider.of<CanteenCubit>(context)
                        .state
                        .currentCanteenUser
                        .getter()[4]) {
                  if (!keyd.data()["Status"]) {
                    if (BlocProvider.of<CanteenCubit>(context)
                            .state
                            .currentCanteenUser
                            .getter()[0]
                            .replaceAll(keyd.data()["Canteen"], "") ==
                        "") {
                      ...
                      Fluttertoast.showToast(msg: "Canteen not Matching!");
